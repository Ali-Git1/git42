...
namespace LuxGamingShop1.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index1()
        {
            ...
            homeIndexVM.Features = _datacontext.Features.ToList();
            homeIndexVM.Gamings = _datacontext.Gamings.ToList();
            homeIndexVM.Homeh = _datacontext.HomeHs.FirstOrDefault();
            homeIndexVM.trendinggame = _datacontext.TrendingGames.ToList();
        ...
        //gaming.Add(new Gaming { Id = 6, Tittle = "Destinity", Path = "top-game-06.jpg", CategoriesName = "AssasinLostark1" });
